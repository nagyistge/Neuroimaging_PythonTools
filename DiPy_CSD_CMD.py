...
def main():
	...
	def DiPy_CSD(participant):
		import os 
		import sys
		raw_folder = '/imaging/jb07/CALM/CALM_BIDS/'
		...
		bvecs = np.vstack([bvecs[0,:],bvecs[1,:],bvecs[2,:]])
		...
		det_dg = ProbabilisticDirectionGetter.from_shcoeff(csd_fit.shm_coeff,
		                                                             max_angle=45.,
